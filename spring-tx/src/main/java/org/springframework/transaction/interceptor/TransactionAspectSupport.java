 ...
 * <pre>
 * +---------------------+    +-------------------------------------------+
 * | 获取事务属性源       |--->| TransactionAspectSupport#getTransaction   |
 * |                     |    | AttributeSource                           |
 * +---------------------+    +-------------------------------------------+
 *       |
 *       v
 ...
 *       v
 * +---------------------+    +---------------------------------------------+
 * | 确定事务管理器       |--->| TransactionAspectSupport#determineTransaction |
 * |                     |    | Manager(txAttr)                             |
 * +---------------------+    +---------------------------------------------+
 *       |
 *       v
 * +---------------------+    +------------------------------------------------+
 * | 创建事务             |--->| TransactionAspectSupport#createTransactionIf   |
 * |                     |    | Necessary                                      |
 * +---------------------+    +------------------------------------------------+
 *       |
 *       v
 ...
 *       |
 *       v                                                +----------------------------------------------------+
 * +---------------------+               提交事务          | TransactionAspectSupport                           |
 * |  提交事务            |     ------------------------>  | #commitTransactionAfter Returning                  |
 * +---------------------+                                +----------------------------------------------------+
 *                                |
 *                                |
 *                                |                        +----------------------------------------------------+
 *                                --------------------->   | TransactionAspectSupport#completeTransactionAfter   |
 *                                      回滚事务            | Throwing                                            |
 *             											   +----------------------------------------------------+
 * </pre>
 */
